...
- القطاعات والتصنيفات: أسماء الأسواق + إضافة/تعديل/ترتيب/حذف تصنيفات مصر
...
> لو ظهرت أخطاء عن `cover_url` أو التصنيفات: شغّل `supabase-migrate.sql` مرة واحدة من SQL Editor.
